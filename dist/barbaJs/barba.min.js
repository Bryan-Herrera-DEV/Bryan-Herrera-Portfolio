!(function (t, n) {
	...
	function E(t, n) {
		return function (r, e) {
			...
			if (!i) return !1;
			for (
				var o = i[0], u = i.index, f = {}, s = (e && e.decode) || decodeURIComponent, c = 1;
				c < i.length;
				c++
			)
				if (void 0 !== i[c]) {
	...
	function T(t, n, r) {
		for (
			...
			if ("string" == typeof a) s += k(a);
				...
				var h = a.repeat
					? "(?:" + a.pattern + ")(?:" + k(a.delimiter) + "(?:" + a.pattern + "))*"
					: a.pattern;
				n && n.push(a),
					(s += a.optional
						? a.prefix
	...
	var X = new ((function (t) {
			...
			return (
				...
				(r.do = function (t) {
					for (
						var n = this, r = arguments.length, e = new Array(r > 1 ? r - 1 : 0), i = 1;
						i < r;
						i++
					)
						e[i - 1] = arguments[i];
		...
		et = (function (t) {
			function n(n) {
				var r;
				return (
					((r = t.call(this, n) || this).suite = []), (r.tests = new Map()), r.init(), r
				);
			}
			e(n, t);
			var r = n.prototype;
	...
	return new ((function () {
		...
		return (
					...
					!(e =
						"popstate" === n
							? this.history.current &&
							  this.url.getPath(this.history.current.url) === this.url.getPath(t)
			...
			(e.onRequestError = function (t) {
				...
				return (
					this.cache.delete(i),
					!((this.$ && !1 === this.$(t, u, i, o)) || ("click" === u && this.force(i), 1))
				);
			}),
			...
			(e.B = function (t) {
				...
				if (r) {
					...
					this.prevent.checkHref(e) ||
						...
						this.cache.set(
							e,
							this.request(e, this.timeout, this.onRequestError.bind(this, r)).catch(
								function (t) {
									n.logger.error(t);
								}
							),
			...
			(e.q = function () {
				...
				(this.C = { current: n, next: r({}, this.schemaPage), trigger: void 0 }),
